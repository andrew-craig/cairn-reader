...
| [x] | P2 IDOR | read/fetcher has **zero** inbound auth; user_id taken from URL path → cross-tenant read/write/delete of subscriptions | 0 | [R1](#r1--closing-an-authorization-gap) |
