...
| [x] task_2658 | C2 + C1 (routes) | read/content write + URL-detection endpoints have no auth: anonymous content overwrite + SSRF | 0 | [R1](#r1--closing-an-authorization-gap) |
