...
| [x] | P3-C2, H6, uncapped bodies | `http.MaxBytesReader` on all JSON endpoints in users/read/fetcher/email + depth guards on the two recursive email HTML walkers | 1 | [R5](#r5--resource-bounding) |
