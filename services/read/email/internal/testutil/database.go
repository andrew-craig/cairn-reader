// Package testutil provides testing utilities for the email ingest service.
// This includes test database setup, connection helpers, and common
// fixtures used across integration tests. Adapted from
// services/read/fetcher/internal/testutil/database.go.
package testutil
...
const (
	...
	defaultTestDBPort     = "5435"
	defaultTestDBUser     = "cairn_email"
	defaultTestDBPassword = "cairn_email_pass"
	defaultTestDBName     = "cairn_email_test"
)
