...
import (
	...
	"github.com/andrew-craig/cairn-read/services/rss-fetcher-service/internal/client"
	"github.com/andrew-craig/cairn-read/services/rss-fetcher-service/internal/database"
	"github.com/andrew-craig/cairn-read/services/rss-fetcher-service/internal/jobs"
	"github.com/andrew-craig/cairn-read/services/rss-fetcher-service/internal/processor"
	...
	"github.com/andrew-craig/cairn-read/services/rss-fetcher-service/internal/worker"
...
func main() {
	...
	subscriptionRepo := repository.NewFeedSubscriptionRepository(db)
	...
	healthServer := setupHealthCheckServer(healthPort, db, logger)
